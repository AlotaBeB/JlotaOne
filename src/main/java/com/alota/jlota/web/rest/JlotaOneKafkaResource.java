...
@RestController
@RequestMapping("/api/jlota-one-kafka")
public class JlotaOneKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JlotaOneKafkaResource.class);
    ...
    public JlotaOneKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
